...
class CLIPProcessor(ProcessorMixin):
    r"""
    Constructs a Base processor which wraps a Base image processor and a Base tokenizer into a single processor.

    [`BaseProcessor`] offers all the functionalities of [`BaseImageProcessor`] and [`BaseTokenizerFast`]. See the
    [`~BaseProcessor.__call__`] and [`~BaseProcessor.decode`] for more information.

    Args:
        image_processor ([`BaseImageProcessor`], *optional*):
            The image processor is a required input.
        tokenizer ([`BaseTokenizerFast`], *optional*):
            The tokenizer is a required input.
    """

    attributes = ["image_processor", "tokenizer"]
    image_processor_class: str
    tokenizer_class: tuple
