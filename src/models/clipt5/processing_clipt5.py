...
__all__ = ["CLIPT5Processor"]

IMG_PROCESSOR_CLASS = "CLIPImageProcessor"
TOKENIZER_CLASS = "T5TokenizerFast"


class CLIPT5ProcessorKwargs(ProcessingKwargs, total=False):
...
@registry.register_processor("CLIPT5Processor")
class CLIPT5Processor(ProcessorMixin):
    ...
    def __call__(
            ...
            audio=None,
            videos=None,
            **kwargs: Unpack[CLIPT5ProcessorKwargs],
    ) -> BatchEncoding:

        if text is None and images is None:
            raise ValueError("You must specify either text or images.")
        output_kwargs = self._merge_kwargs(
            CLIPT5ProcessorKwargs,
